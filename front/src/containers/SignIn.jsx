                ...
                <form autoComplete="off" >
                    ...
                    >
                        <div className={classes.headerUpload}>
                            <p className={classes.titleUpload}>INGRESAR</p>
                        ...
                        <div className={classes.enviar}>
                            <DialogActions >
                                <Button onClick={(e) => this.handleSubmit(e)} className={classes.button} variant="contained" color='primary' component="span" >INGRESAR</Button>
                            </DialogActions>
                        </div>
                    </Dialog>
                </form>
